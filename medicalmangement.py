...
#**********************MAinVariable********************************************
                ...
                img1=Image.open("D:\Medical Management System & Billing\logo.jpg")
        ...
        # ******************************Labels And Entry********************************
                ...
                conn=mysql.connector.connect(host="localhost",username="Nikhil",password="Root@123",database="medical")
        ...
        #*********************************Images**************************
                img2=Image.open("D:\Medical Management System & Billing\Inget.jpg")
                ...
                img3=Image.open("D:\Medical Management System & Billing\Med.jpg")
                ...
                img4=Image.open("D:\Medical Management System & Billing\Capsule.jpg")
        ...
        # **********************************DataFrame Right********************************
                ...
                img5=Image.open("D:\Medical Management System & Billing\Presc.jpg")
                img5=img5.resize((200,90),Image.ANTIALIAS)
                self.photoimg5=ImageTk.PhotoImage(img5)
                b1=Button(self.root,image=self.photoimg5,borderwidth=0)
                b1.place(x=950,y=170)

                img6=Image.open("D:\Medical Management System & Billing\Doct.jpg")
                ...
                img7=Image.open("D:\Medical Management System & Billing\shop.jpg")
        ...
        #********************************FrameDetails********************************************************
                ...
                self.pharmacy_table=ttk.Treeview(Table_frame,columns=("RefName","companyname","TypeMed","Medicinename","LotNo","IssueDate",
                ...
                self.pharmacy_table.heading("RefName",text="Ref")
                ...
                self.pharmacy_table.column("RefName",width=20)
...
#**************************Main Table*************************************************************
        ...
        def Update(self):
                if self.ref_no_var.get()=="" or self.LotNo.get()=="":
                        ...
                        conn=mysql.connector.connect(host="localhost",username="Nikhil",password="Root@123",database="medical")
                        my_cursor=conn.cursor()
                        my_cursor.execute("Update pharmacy set companyname=%s,TypeMed=%s,MedicineName=%s,LotNo=%s,IssueDate=%s,ExpDate=%s,Symptom=%s,SideEff=%s,Precaution=%s,Dosage=%s,price=%s,ProductQt=%s where RefName=%s",(
                                                                                        self.campanyName.get(),
                                                                                        self.TypeMed.get(),
                                                                                        self.Medicinename.get(),
                                                                                        self.LotNo.get(),
        ...
        def Delete(self):
                ...
                sql="delete from Pharmacy where RefName=%s"
